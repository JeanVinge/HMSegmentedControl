Pod::Spec.new do |s|
  s.name         = "CatalystHMSegmentedControl"
  s.version      = "1.5.4"
  ...
  s.homepage     = "https://github.com/JeanVinge/HMSegmentedControl"
  s.license      = { :type => 'MIT', :file => 'LICENSE.md' }
  s.author       = { "Hesham Abd-Elmegid" => "hesham.abdelmegid@gmail.com" }
  s.source       = { :git => "https://github.com/JeanVinge/HMSegmentedControl.git", :tag => "v1.5.4" }
  s.platform     = :ios, '7.0'
  s.requires_arc = true
